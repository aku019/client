...
import CodechefIcon from '../logo/codechef.png';
import HackerRankIcon from '../logo/Hackerrank.png';
import TwitteIcon from '../logo/twitter.png';
import MediumIcon from '../logo/medium.png';
import ProfileInput from './profileip';
...
const Modal = ({ modalClose }) => {
    ...
    const onSubmitHandler = async () => {
        if (github) {
            ...
            try {
                await axios.post('http://localhost:3001/api/developers/', data, {
                    headers: {
