...
import { ReactComponent as UserIcon } from '../logo/account.svg';
import HackerRankImage from '../logo/Hackerrank.png';
import CodeChefImage from '../logo/codechef.png';
import LinkedInImage from '../logo/linkedin.png';
import MediumImage from '../logo/medium.png';
import TwitterImage from '../logo/twitter.png';
import { ReactComponent as EmailIcon } from '../logo/email.svg';
import { ReactComponent as LocationIcon } from '../logo/location.svg';
import { ReactComponent as LinkIcon } from '../logo/insert_link.svg';
import { ReactComponent as OfficeIcon } from '../logo/business.svg';
import { ReactComponent as ArrowIcon } from '../logo/north_east.svg';
import Footer from '../component/footer';
import ProfileIcon from '../component/profilepic';
    ...
    useEffect(() => {
        try {
            const getDeveloperProfile = async () => {
                const data = await axios.get(`http://localhost:3001/api/developers/${id}`);
